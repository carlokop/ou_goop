...
public class TestAfspraak {
  ...
  public void ItemHappyTest() throws IllegalStateException, DatumVerledenException {
    ...
    i1 = new Item(1,"Afspraak", d1, t1, t2);
    assertEquals(i1.getTitel(),"Afspraak");
    assertEquals(i1.getId(),1);
    assertEquals(i1.getDatum().toString(),"2024-06-14");
    
    //negatieve id of id = 0
    assertThrows(IllegalArgumentException.class, () -> { new Item(-1,"Afspraak", d1, t1, t2); });
    assertThrows(IllegalArgumentException.class, () -> { new Item(0,"Afspraak", d1, t1, t2); });
  ...
  public void ItemOngeldigeWaardeTest() throws NullPointerException, IllegalArgumentException, IllegalStateException, DatumVerledenException {
    ...
    assertThrows(NullPointerException.class, () -> { new Item(1,null, d1, t1, t2); });
    assertThrows(IllegalArgumentException.class, () -> { new Item(1,"", d1, t1, t2); });
    ...
    assertThrows(IllegalStateException.class, () -> { new Item(1,"Afspraak", d1, t1, t1); });
    ...
    assertThrows(DatumVerledenException.class, () -> { new Item(1,"Afspraak", d4, t1, t2); });
    
    //begindatum vandaag && begintijd < nu
    assertThrows(DatumVerledenException.class, () -> { new Item(1,"Afspraak", d1, t7, t3); });

    //eindtijd < begintijd
    assertThrows(IllegalStateException.class, () -> { new Item(1,"Afspraak", d6, t5, t7); });
